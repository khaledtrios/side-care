...
export default function TransportFormRecurrent({ currentTransport }) {
  ...
  const transportTypes = ['Transport domicile-travail', 'Forfait mensuel', 'Transport public', 'Transport personnel'];

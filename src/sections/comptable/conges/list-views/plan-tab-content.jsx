  ...
  return (
    <Paper>
      <Box
        ...
        p={2}
      >
        <Typography variant="h5" sx={{ mr: { xs: 0, sm: 2 }, mb: { xs: 2, sm: 0 } }}>
          Planning
        </Typography>
          ...
          <Box display="flex" alignItems="center">
            ...
            <Box sx={{ mx: 2, display: 'flex', gap: 1 }}>
              <FormControl size="small" sx={{ minWidth: 120 }}>
                ...
                <Select value={currentMonth} onChange={handleMonthChange} label="Mois">
              ...
              <FormControl size="small" sx={{ minWidth: 120 }}>
                ...
                <Select value={currentYear} onChange={handleYearChange} label="Année">
                  {yearsRange.map((year) => (
      ...
      {tabs.value === 'month' ? (
        <PlanMonth employees={employees} month={currentMonth} year={currentYear} />
      ) : (
        <PlanWeek employees={employees} startDate={currentWeekStart} />
      )}
    </Paper>
  );
}

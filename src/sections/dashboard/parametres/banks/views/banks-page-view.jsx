...
import AddBankModal from 'src/sections/dashboard/employes/entreprises/display/add-bank-modal';
...
export default function BanksPageView() {
      ...
      <TableRow>
        ...
        <TableCell align="right" sx={{ px: 1 }}>
          <Stack flexDirection="row">
            <Button
              variant="contained"
              startIcon={<Iconify icon="tabler:trash" />}
              color="error"

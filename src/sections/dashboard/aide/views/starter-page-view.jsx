...
export default function StarterPageView() {
  ...
  const items = [
    ...
    },
    {
      ...
      action: (
        <Button
          onClick={() => router.push(paths.dashboard.parametres.admins.root)}
          variant="outlined"
        >
          Ajouter
        </Button>
    ...
    },
    {
      ...
      action: (
        <Button
          onClick={() => router.push(paths.dashboard.parametres.cabinets.root)}
          variant="outlined"
        >
          Ajouter
        </Button>
    ...
    },
    {
      ...
      action: (
        <Button onClick={() => router.push(paths.dashboard.account.root)} variant="outlined">
          Paramétrer
        </Button>
      ),
    ...
    },
    {
      ...
      action: (
        <Button onClick={() => router.push(paths.dashboard.parametres.root)} variant="outlined">
          Activer
        </Button>
      ),

...
import { RejectionFiles } from './components/rejection-files'; // <-- we'll customize this too
...
export function UploadAvatar({ sx, error, value, disabled, helperText, className, ...other }) {
  ...
  const renderPlaceholder = (
    ...
    >
      ...
      <Typography variant="caption">
        {hasFile ? 'Modifier la photo' : 'Téléverser une photo'}
      </Typography>
    </Box>
  );
  ...
  return (
    <>
      ...
      {/* ✅ Custom French file error messages */}
      {fileRejections.length > 0 && (
        <RejectionFiles
          files={fileRejections}
          messages={{
            fileTooLarge: 'Le fichier est trop volumineux.',
            fileInvalidType: 'Type de fichier non autorisé.',
